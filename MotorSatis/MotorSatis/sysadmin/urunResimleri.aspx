<%@ Page Title="" Language="C#" MasterPageFile="~/sysadmin/Admin.master" AutoEventWireup="true" CodeFile="urunResimleri.aspx.cs" Inherits="sysadmin_urunResimleri" %>
            ...
            <asp:DataList ID="DataList1" runat="server" RepeatColumns="1" DataKeyField="ID" ForeColor="#333333" OnItemCommand="DataList1_ItemCommand" Width="100%">
                ...
                <ItemTemplate>
                    <div class="referanslar-kucuk-resim-alani-2">
                        <img src="../dinamikimg/ExtraUrunler/<%#Eval("UrunResim") %>"   border="0" />
                        <br />
                        <br />
                    ...
                    <asp:HiddenField runat="server" ID="hdresim" Value='<%#Eval("UrunResim") %>'></asp:HiddenField>
                    <br />
                </ItemTemplate>
